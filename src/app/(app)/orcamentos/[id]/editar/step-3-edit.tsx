...
export function QuoteStep3Edit({ quoteId }: { quoteId: string }) {
    ...
    <div className="space-y-4">
          ...
          return (
            ...
            >
              <div>
                ...
                <p className="text-xs text-noite/50">{catItems.length} item(ns)</p>
              </div>
      ...
      <div className="card space-y-3">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-mono text-noite">{formatBRL(draft.totalGross)}</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <input
              type="text"
              inputMode="decimal"
              value={draft.discountPct > 0 ? (draft.discountPct * 100).toFixed(0) : ""}
              onChange={(e) => {
        ...
        {discountValue > 0 && (
          <div className="flex justify-between text-sm">
            ...
            <span className="font-mono text-coral">-{formatBRL(discountValue)}</span>
          </div>
        )}
